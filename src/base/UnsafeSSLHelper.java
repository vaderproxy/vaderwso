...
public class UnsafeSSLHelper {
     ...
     * Usage
     *
     * common usage sample: (new UnsafeSSLHelper()).ignoreSSLCertif(); // then
     * make your https connection
     *
     * Apache HttpClient example: UnsafeSSLHelper unsafeSSLHelper = new
     * UnsafeSSLHelper(); CloseableHttpClient client = HttpClientBuilder
     * .create() .setSslcontext(unsafeSSLHelper.createUnsecureSSLContext())
